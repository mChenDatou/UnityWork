...
namespace CDT
{
    ...
    class JsonExporter
    {
        ...
        public JsonExporter(DataTable sheet, bool lowcase, bool exportArray, string dateFormat, bool forceSheetName, int headerRows, string excludePrefix, bool cellJson, bool allString)
        {
